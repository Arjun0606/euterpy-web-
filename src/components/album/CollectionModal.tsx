...
export default function CollectionModal({
  ...
  const [medium, setMedium] = useState<string>(existing?.ownership || "digital");
  ...
  useEffect(() => {
    ...
    supabase
      ...
      .single()
      .then(({ data }) => {
        // Score >= 4 is treated as 'loved' for back-compat
  ...
  async function handleSave() {
    ...
    try {
      ...
      // Score is now an internal signal: 5 = loved, 3 = in collection (neutral)
      // We keep the column for backend sorting but never expose it in UI
      ...
      toast(loved ? `❤ Added — ${albumTitle}` : `Added to your collection`);
      onSaved();
      onClose();
    } catch {
      ...
      >
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <h3 className="font-display text-xl tracking-tight truncate">{albumTitle}</h3>
        ...
        {/* Medium */}
        <div className="mb-6">
          <p className="text-[10px] uppercase tracking-[0.18em] text-zinc-600 mb-3">How do you have it?</p>
        ...
        <div className="mb-6">
          ...
          <textarea
            placeholder="What does this album mean to you?"
            value={story}
